...
export const metadata: Metadata = {
  ...
  description: "Solar panel installation in Dapto. Honest pricing from $5,500 after rebates. 5-minute callback guarantee. 10-year workmanship warranty.",
  alternates: { canonical: "https://coastalsolar.com.au/locations/dapto" },
};
