...
export const metadata: Metadata = {
  title: "Solar Panels Berry | Local Installer | Coastal Solar Co.",
  description: "Solar panel installation in Berry & Southern Highlands gateway. 6.6kW from $5,500 after rebates. CEC-accredited local team, 5-minute callback, 6-day installation, 10-year warranty.",
  alternates: { canonical: "https://coastalsolarco.com/locations/berry" },
};
...
const schema = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Coastal Solar Co. — Solar Panels Berry",
      "url": "https://coastalsolarco.com/locations/berry",
      ...
      "areaServed": { "@type": "City", "name": "Berry" },
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Berry", "item": "https://coastalsolarco.com/locations/berry" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <section className="gradient-hero text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-white/60 text-sm mb-6">
            <Link href="/" className="hover:text-white">Home</Link> &rsaquo; <Link href="/locations" className="hover:text-white">Locations</Link> &rsaquo; <span className="text-white">Berry</span>
          </nav>
          <h1 className="text-4xl lg:text-5xl font-black mb-4" style={{ fontFamily: "var(--font-montserrat)" }}>
            Solar Panels for Berry Homes
          </h1>
          <p className="text-xl text-white/85 max-w-2xl mb-8">Solar installation in Berry and the Southern Highlands gateway region.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black mb-6" style={{ fontFamily: "var(--font-montserrat)", color: "var(--color-primary)" }}>
                Solar Installation in Berry
              </h2>
              <p className="text-gray-700 mb-4">Berry&apos;s heritage homes and growing new estate developments are increasingly turning to solar. The township benefits from strong inland solar irradiance, and many Berry properties are ideal candidates for battery storage given their semi-rural grid positioning.</p>
      ...
      <section className="py-16 section-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black text-center mb-10" style={{ fontFamily: "var(--font-montserrat)", color: "var(--color-primary)" }}>
            Berry Solar Pricing (After Rebates)
          </h2>
          ...
          <div className="text-center mt-8">
            <Link href="/solar-calculator" className="btn-primary text-lg">Get My Exact Berry Quote &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 gradient-hero text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl font-black mb-4" style={{ fontFamily: "var(--font-montserrat)" }}>Ready to go solar in Berry?</h2>
