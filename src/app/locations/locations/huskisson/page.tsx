...
export const metadata: Metadata = {
  title: "Solar Panels Huskisson | Local Installer | Coastal Solar Co.",
  description: "Solar panel installation in Huskisson & Jervis Bay village. 6.6kW from $5,500 after rebates. CEC-accredited local team, 5-minute callback, 6-day installation, 10-year warranty.",
  alternates: { canonical: "https://coastalsolarco.com/locations/huskisson" },
};
...
const schema = {
  ...
  "@graph": [
    {
      "@type": "LocalBusiness",
      "name": "Coastal Solar Co. — Solar Panels Huskisson",
      "url": "https://coastalsolarco.com/locations/huskisson",
      ...
      "areaServed": { "@type": "City", "name": "Huskisson" },
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 3, "name": "Huskisson", "item": "https://coastalsolarco.com/locations/huskisson" },
      ],
    },
  ],
};
    ...
    <>
      ...
      <section className="gradient-hero text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="text-white/60 text-sm mb-6">
            <Link href="/" className="hover:text-white">Home</Link> &rsaquo; <Link href="/locations" className="hover:text-white">Locations</Link> &rsaquo; <span className="text-white">Huskisson</span>
          </nav>
          <h1 className="text-4xl lg:text-5xl font-black mb-4" style={{ fontFamily: "var(--font-montserrat)" }}>
            Solar Panels for Huskisson Homes
          </h1>
          <p className="text-xl text-white/85 max-w-2xl mb-8">Solar installation in Huskisson and the Jervis Bay village area.</p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-black mb-6" style={{ fontFamily: "var(--font-montserrat)", color: "var(--color-primary)" }}>
                Solar Installation in Huskisson
              </h2>
              <p className="text-gray-700 mb-4">Huskisson&apos;s coastal township is seeing strong solar uptake as electricity costs rise. We specialise in installation on both permanent residences and investment/holiday properties in the Jervis Bay village area, Huskisson, and nearby Vincentia.</p>
      ...
      <section className="py-16 section-accent">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-black text-center mb-10" style={{ fontFamily: "var(--font-montserrat)", color: "var(--color-primary)" }}>
            Huskisson Solar Pricing (After Rebates)
          </h2>
          ...
          <div className="text-center mt-8">
            <Link href="/solar-calculator" className="btn-primary text-lg">Get My Exact Huskisson Quote &rarr;</Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 gradient-hero text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl font-black mb-4" style={{ fontFamily: "var(--font-montserrat)" }}>Ready to go solar in Huskisson?</h2>
