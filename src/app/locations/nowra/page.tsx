...
export const metadata: Metadata = {
  ...
  description: "Solar panel installation in Nowra. Honest pricing from $5,500 after rebates. 5-minute callback guarantee. 10-year workmanship warranty.",
  alternates: { canonical: "https://coastalsolar.com.au/locations/nowra" },
};
