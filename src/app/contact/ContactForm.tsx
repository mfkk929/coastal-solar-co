        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              {[
                ...
                { id: "suburb", label: "Suburb", type: "text", required: false, placeholder: "e.g. Kiama" },
              ].map(field => (
                <div key={field.id}>
          ...
          <div>
            ...
            <div className="space-y-6">
              {[
                { icon: "📞", label: "Phone", value: "0493 531 857", href: "tel:0493531857" },
                { icon: "✉️", label: "Email", value: "info@coastalsolarco.com", href: "mailto:info@coastalsolarco.com" },
                { icon: "📍", label: "Service Area", value: "Kiama, Illawarra & South Coast NSW", href: null },
